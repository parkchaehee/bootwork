...
import com.khit.config.SecurityUser;
import com.khit.dto.MemberDTO;
import com.khit.entity.Member;
import com.khit.exception.BootBoardException;
import com.khit.repository.MemberRepository;
...
public class MemberService {
	...
	public void save(MemberDTO memberDTO) {
		//1. 비밀번호 암호화
		//2. 권한 설정
		String encPW = pwEncoder.encode(memberDTO.getMemberPassword());
		memberDTO.setMemberPassword(encPW);
